<template>
  <div class="min-h-screen w-full bg-gray-50">
    ...
    >
      <div
        class="bg-red-50 border border-red-200 rounded-lg p-8 transition-all hover:shadow-lg"
      >
        ...
        <button
          @click="fetchProduct"
          class="mt-4 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all hover:shadow-md"
        >
          Try Again
        </button>
      </div>
    ...
    <div
      v-else-if="product"
      class="flex flex-col items-center mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12"
    >
      <!-- Breadcrumb -->
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          <div style="padding-top: 0.25rem" class="space-y-4">
            <div
              class="bg-white rounded-xl shadow-md overflow-hidden aspect-square relative transition-shadow hover:shadow-xl"
            >
              <img
                :src="
                  buildImagePath(product.images[currentImageIndex]) ||
          ...
          <div class="product-info-section">
            ...
            <div class="title-and-brand border-b border-gray-200">
              ...
              <p class="text-lg text-gray-600">
                SKU:
                <span class="text-green-700 font-bold">{{ product.sku }}</span>
              </p>
              <!-- Attributes/Tags -->
              <div
            ...
            <div>
              <span
                ...
                class="inline-flex items-center px-4 py-2 rounded-full text-lg font-medium bg-green-100 text-green-800 transition-all hover:bg-green-200"
              >
                <svg
                  class="w-5 h-5 mr-2"
                  fill="currentColor"
              ...
              <span
                v-else
                class="inline-flex items-center px-4 py-2 rounded-full text-lg font-medium bg-red-100 text-red-800"
              >
                Out of Stock
              </span>
            </div>
            ...
            <div>
              <div>
                <label
                  ...
                  class="block text-lg sm:text-xl font-medium text-gray-700"
                  >Quantity</label
                >
      ...
      <div
        ...
        class="bg-white rounded-xl shadow-md p-6 sm:p-8 lg:p-10 w-[90%]"
      >
        ...
        <div class="mb-10 pb-10 border-b border-gray-200">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div class="text-center md:text-left">
              <div class="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
                {{ reviews.avgRating }}
              </div>
        ...
        <div
          v-if="showReviewForm"
          class="mb-10 p-6 sm:p-8 bg-gray-50 rounded-xl transition-all"
        >
        ...
        <div v-if="reviewsLoading" class="text-center py-12">
          <div
            class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-green-500 mx-auto"
          ></div>
        </div>
...
async function fetchReviews(page = 1) {
  try {
    ...
    const response = await axios.get(
      `/api/products/${productId.value}/reviews`,
      {
        params: {
          page,
